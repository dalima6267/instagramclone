...
import com.dalima.instagramclone.databinding.ReelDgBinding
import com.dalima.instagramclone.models.Reel
import com.squareup.picasso.Picasso

class ReelAdapter(var context: android.content.Context, var reelList: ArrayList<Reel>) :RecyclerView.Adapter<ReelAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        Picasso.get().load(reelList.get(position).profileLink).placeholder(R.drawable.user).into(holder.binding.imgProfile)
